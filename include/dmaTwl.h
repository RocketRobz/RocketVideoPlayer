...
#define NDMAGCNT_YIELD_CYCLES_0         (0u << 16)
#define NDMAGCNT_YIELD_CYCLES_1         (1u << 16)
#define NDMAGCNT_YIELD_CYCLES_2         (2u << 16)
#define NDMAGCNT_YIELD_CYCLES_4         (3u << 16)
#define NDMAGCNT_YIELD_CYCLES_8         (4u << 16)
#define NDMAGCNT_YIELD_CYCLES_16        (5u << 16)
#define NDMAGCNT_YIELD_CYCLES_32        (6u << 16)
#define NDMAGCNT_YIELD_CYCLES_64        (7u << 16)
#define NDMAGCNT_YIELD_CYCLES_128       (8u << 16)
#define NDMAGCNT_YIELD_CYCLES_256       (9u << 16)
#define NDMAGCNT_YIELD_CYCLES_512       (10u << 16)
#define NDMAGCNT_YIELD_CYCLES_1024      (11u << 16)
#define NDMAGCNT_YIELD_CYCLES_2048      (12u << 16)
#define NDMAGCNT_YIELD_CYCLES_4096      (13u << 16)
#define NDMAGCNT_YIELD_CYCLES_8192      (14u << 16)
#define NDMAGCNT_YIELD_CYCLES_16384     (15u << 16)

#define NDMAGCNT_ARBITRATION_FIXED          (0u << 31)
#define NDMAGCNT_ARBITRATION_ROUND_ROBIN    (1u << 31)
...
#define NDMABCNT_PRESCALER_1            (0u << 16)
#define NDMABCNT_PRESCALER_4            (1u << 16)
#define NDMABCNT_PRESCALER_16           (2u << 16)
#define NDMABCNT_PRESCALER_64           (3u << 16)

#define NDMACNT_DST_MODE_INCREMENT      (0u << 10)
#define NDMACNT_DST_MODE_DECREMENT      (1u << 10)
#define NDMACNT_DST_MODE_FIXED          (2u << 10)

#define NDMACNT_DST_RELOAD              (1u << 12)

#define NDMACNT_SRC_MODE_INCREMENT      (0u << 13)
#define NDMACNT_SRC_MODE_DECREMENT      (1u << 13)
#define NDMACNT_SRC_MODE_FIXED          (2u << 13)
#define NDMACNT_SRC_MODE_FILLDATA       (3u << 13)

#define NDMACNT_SRC_RELOAD              (1u << 15)

#define NDMACNT_PHYSICAL_COUNT_1        (0u << 16)
#define NDMACNT_PHYSICAL_COUNT_2        (1u << 16)
#define NDMACNT_PHYSICAL_COUNT_4        (2u << 16)
#define NDMACNT_PHYSICAL_COUNT_8        (3u << 16)
#define NDMACNT_PHYSICAL_COUNT_16       (4u << 16)
#define NDMACNT_PHYSICAL_COUNT_32       (5u << 16)
#define NDMACNT_PHYSICAL_COUNT_64       (6u << 16)
#define NDMACNT_PHYSICAL_COUNT_128      (7u << 16)
#define NDMACNT_PHYSICAL_COUNT_256      (8u << 16)
#define NDMACNT_PHYSICAL_COUNT_512      (9u << 16)
#define NDMACNT_PHYSICAL_COUNT_1024     (10u << 16)
#define NDMACNT_PHYSICAL_COUNT_2048     (11u << 16)
#define NDMACNT_PHYSICAL_COUNT_4096     (12u << 16)
#define NDMACNT_PHYSICAL_COUNT_8192     (13u << 16)
#define NDMACNT_PHYSICAL_COUNT_16384    (14u << 16)
#define NDMACNT_PHYSICAL_COUNT_32768    (15u << 16)

#define NDMACNT_MODE_TIMER_0            (0u << 24)
#define NDMACNT_MODE_TIMER_1            (1u << 24)
#define NDMACNT_MODE_TIMER_2            (2u << 24)
#define NDMACNT_MODE_TIMER_3            (3u << 24)
#define NDMACNT_MODE_DS_SLOTA_ROM_XFER  (4u << 24)
#define NDMACNT_MODE_DS_SLOTB_ROM_XFER  (5u << 24)
#define NDMACNT_MODE_VBLANK             (6u << 24)

#ifdef LIBTWL_ARM9

#define NDMACNT_MODE_HBLANK             (7u << 24)
#define NDMACNT_MODE_DISPLAY            (8u << 24)
#define NDMACNT_MODE_MMEM_DISP_FIFO     (9u << 24)
#define NDMACNT_MODE_GX_FIFO            (10u << 24)
#define NDMACNT_MODE_CAMERA             (11u << 24)

#endif

#ifdef LIBTWL_ARM7

#define NDMACNT_MODE_WIFI               (7u << 24)
#define NDMACNT_MODE_SDMMC              (8u << 24)
#define NDMACNT_MODE_SDIO               (9u << 24)
#define NDMACNT_MODE_AES_IN             (10u << 24)
#define NDMACNT_MODE_AES_OUT            (11u << 24)
#define NDMACNT_MODE_MIC                (12u << 24)

#endif

#define NDMACNT_MODE_IMMEDIATE          (1u << 28)
#define NDMACNT_REPEAT_INFINITELY       (1u << 29)
#define NDMACNT_IRQ                     (1u << 30)
#define NDMACNT_ENABLE                  (1u << 31)
